...
function newsFeed(): void {
    ...
    let template = `
        ...
        <h1 class='font-extrabold'>조니의 룰루랄라 피드</h1>
        </div>
        <div class='items-center justify-end'>
        <a href='#/page/{{__룰루_page__}}' class='text-gray-500'>
        Previous |
        <a href='#/page/{{__랄라_page__}}' class='text-gray-500'>
        Next
        </a>
        </div>
        </div>
  ...
  `
    ...
    for (
        ...
        newsList.push(
            `
    <div class='p-6 ${
        !newsFeed[i].read ? 'bg-white' : 'bg-red-500'
...
`
    ...
    // TODO, 여기가 아마 31개 이상이 없음 경우 EMPTY Page가 되도록 처리 해야 할듯
    updateView(template)
}
...
function newsDetail() {
    ...
    <div class='flex justify-between items-center py-6'>
    <div class='flex justify-start'>
    <h1 class='font-extrabold'>조니의 룰루랄라 피드 상세</h1>
</div>
    <div class='items-center justify-end'>
    ...
    <div class='text-gray-400 h-20'>${newsContent.content}
</div>{{__comments__}}
  `
