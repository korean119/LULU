...
var contaitner = document.getElementById("root");
var ajax = new XMLHttpRequest();
var content = document.createElement("div");
var NEWS_URL = "https://api.hnpwa.com/v0/news/1.json";
var CONETENT_URL = "https://api.hnpwa.com/v0/item/@id.json";
var store = {
  currentPage: 1
};
...
function newsFeed() {
  ...
  for (var i = 0; i < 10; i++) {
    ...
    newsList.push("</ul>");
    newsList.pusg('<div><a href="#/page/${store.currentPage}">다음 페이지</a></div>');
    contaitner.innerHTML = newsList.join("");
  }
}
function newsDetail() {
  var id = location.hash.substr(1);
  var newsContent = getData(CONETENT_URL.replace("@id", id));
